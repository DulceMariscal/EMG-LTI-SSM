...
fR=datSet.estimateVar; %This estimate is usually much smaller than those obtained through EM on all the data, for any order, eventhough this shoudl over estimate the true R
...
save(['../../res/AP_CVfixR3_' nw '.mat'],'fitMdlAPfixR', 'outlogAPfixR', 'datSetAP', 'opts');
%% Visualize CV log
